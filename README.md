...
AI suggests next steps in kid-friendly language
Instant visual feedback and achievements
Projects: games, interactive stories, creative tools

2. Elder Tier

Large, high-contrast UI with generous spacing
Voice-enabled input and navigation
Step-by-step guidance with no jargon
Projects: family websites, photo albums, blogs
...
cd frontend
npm run dev
Visit http://localhost:5173 to see DreamForge in action!
📸 Screenshots
Coming soon - add screenshots after building MVP
🎬 Demo Video
Link to demo video will be added here
🏆 What Makes DreamForge Special
✨ Empathy-Driven Design: Not just "accessible" but genuinely adaptive to each learner's needs
✨ Tackles Real Exclusion: Addresses ageism in tech from both directions—too young and too old
✨ Working Prototype: Fully functional demo, not just mockups
✨ Scalable Vision: Clear path from hackathon MVP to impactful product
✨ Emotional Resonance: Every judge knows someone this would help
🔮 Future Vision

All 4 Tiers: Middle School, High School, College, Elder
Community Gallery: Share and discover projects across generations
Mentorship Matching: College students help elders, earn community service hours
School Partnerships: Integrate into libraries and educational institutions
